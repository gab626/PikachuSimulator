...
def main():
    ...
    x3l,y3l,yerr3l = np.loadtxt("r3_amp_loc.txt", unpack=True)
    ...
    popt3, pcov3 = curve_fit(amplitude, x3, y3, p0=P3, sigma=yerr3,
                             bounds=([r3 - 1000, l - 5E-3, c - 1E-8, v0 - 1, rl - 15], [r3 + 1000, l + 5E-3, c + 1E-8, v0 + 1, rl + 15]), maxfev=50000)
    ...
    popt2l, pcov2l = curve_fit(amplitude, x2l, y2l, p0=P2, sigma=yerr2l,
                             bounds=([r2 - 270, l - 5E-3, c - 1E-8, v0 - 1, rl - 15], [r2 + 270, l + 5E-3, c + 1E-8, v0 + 1, rl + 15]), maxfev=50000)
    popt3l, pcov3l = curve_fit(amplitude, x3, y3, p0=P3, sigma=yerr3,
                             bounds=([r3 - 1000, l - 5E-3, c - 1E-8, v0 - 1, rl - 15], [r3 + 1000, l + 5E-3, c + 1E-8, v0 + 1, rl + 15]), maxfev=50000)
    ...
    print("R3: ", popt3l[0], "\nL: ", popt3l[1], "\nC: ", popt3l[2], "\nV0: ", popt3l[3], "\nRl: ", popt3l[4],
           "\nX2 / ndf: ", rcs(x3l, y3l, yerr3l, popt3l), "\n")
    ...
    plt.errorbar(x3l,y3l,yerr=yerr3l, linestyle= 'None', color = 'yellowgreen')
    ...
    plt.plot(x3l, y3l, '.', label = "dati sperimentali R3", color = 'yellowgreen', markersize=5.0)
    plt.plot(x1l, amplitude(x1l, *popt1l), color = 'red', label = "R1 fit")
    plt.plot(x2l, amplitude(x2l, *popt2l), color = 'blue', label = "R2 fit")
    plt.plot(x3l, amplitude(x3l, *popt3l), color = 'green', label = "R3 fit")
    plt.xlim(1800, 2800)
    plt.ylim(0, 5)
    plt.xlabel("frequenza (Hz)", fontsize=20.0)
    plt.ylabel("ampiezza (V)", fontsize=20.0)
